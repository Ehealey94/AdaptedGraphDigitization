...
if size(I,3)==1
    ...
    gray_img = imadjust(Cut,[0.79 0.8],[0 1],1.5);
   ...
   % imshow(gray_img)
    ...
    gray_img = imadjust(gray_img,[0.99 0.995],[0 1]);
  
 %gray_img = imadjust(gray_img,[0.7 0.9],[0 1],1.5);

  %  gray_img = imadjust(Cut,[0.89 0.9],[0 1],1.5);
    
%     
%     RGB2 = imadjust(gray_img,[.2 .3 0; .7 .6 0.5],[],0.8);
end
